...
//ES_t TimerFWM_enuASyDelay(f32 f32delay,void (*Localtptrfunc)(void*),void *parameter);
//ES_t TimerPhaseCorrect_enuASyDelay(f32 f32delay,void (*Localtptrfunc)(void*),void *parameter);
